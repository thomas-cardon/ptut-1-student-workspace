...
export default function Searchbar() {
  ...
  return (<>
    <div className={styles['input-container']} style={input !== '' && filtered.length > 0 ? { borderBottomLeftRadius: 0, borderBottomRightRadius: 0 } : {}}>
      ...
      <input ref={inputEl} id="search" name="search" type="text" placeholder="Recherchez des actions rapides" autoComplete="off" value={input} onChange={e => setUserInput(e.target.value)} />
    </div>
