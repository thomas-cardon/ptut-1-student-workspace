 ...
 * @return {String}        [L'URL]
 */
export function getURL(school, degree, year, user) {
  return uni[school][degree]._url + '&resources=' + (user && year === 'Prof' && user.resourceId ? user.resourceId : uni[school][degree][year].resources.join(','));
}
